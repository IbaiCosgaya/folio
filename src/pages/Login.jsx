...
// ── Folio logo — full version with tagline ────────────────────────────────────

function FolioLogo() {
  return (
    <svg viewBox="0 0 680 400" width="220" height="129" style={{ display: 'block', margin: '0 auto' }}>
  ...
  return (
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '380px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          <button
            ...
            style={{
              ...
              background: loading || !email || !password ? '#e8e4df' : '#1a1714',
              color: loading || !email || !password ? '#9c9490' : '#f8f6f2',
        ...
        {error && (
          <p style={{
            textAlign: 'center', fontSize: '12px', color: '#dc2626',
        ...
        <p style={{
          textAlign: 'center', fontSize: '13px', color: '#9c9490',
          marginTop: '28px', letterSpacing: '-0.005em',
        }}>
          ¿No tienes cuenta?{' '}
          <span
            onClick={() => navigate('/register')}
            style={{ color: '#c9a87c', fontWeight: 700, cursor: 'pointer' }}
          >
            Regístrate
          </span>
        </p>
